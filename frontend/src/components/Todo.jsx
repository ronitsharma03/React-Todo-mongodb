...
export const Todo = ({ title, description, Date, marked }) => {
    ...
    return (
        <div className={`rounded-lg relative cursor-pointer ${isClicked ? 'z-10' : ''}`} onClick={handleclick}>
...

            {
                isClicked && (
                    <div className={`fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-70 cursor-default`}>
                        <div className={`bg-blue-100 dark:bg-slate-800 min-w-96 max-w-[35%] h-60 rounded-md border border-slate-800 overflow-hidden`}>
                            <div className="h-full grid grid-rows-8 grid-cols-4">
                                ...
                                <div className="px-2 py-3 w-full col-span-4 row-span-6">
