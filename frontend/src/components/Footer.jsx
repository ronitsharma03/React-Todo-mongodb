import { IconGithub, IconListTodo } from "./Icon"
export const Footer = () => {
    return (
        <footer className="w-full bg-blue-500 dark:bg-blue-900 p-5">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
                    ...
                    <div className="flex space-x-4 sm:justify-center items-center">
                        <a href="https://www.twitter.com/devxronit" target="_blank" className="w-9 h-9 flex justify-center items-center p-2 rounded-full hover:bg-indigo-600">
                        ...
                        <a href="https://www.instagram.com/ronit__x9" target="_blank" className="w-9 h-9 rounded-full flex justify-center items-center hover:bg-indigo-600">
                        ...
                        <a href="https://www.linkedin.com/in/ronit-khajuria-394609228/" target="_blank" className="w-9 h-9 rounded-full  flex justify-center items-center hover:bg-indigo-600">
                        ...
                        <a href="https://www.github.com/ronitsharma03" target="_blank" className="w-9 h-9 rounded-full flex justify-center items-center hover:bg-indigo-600">
                            <IconGithub />
